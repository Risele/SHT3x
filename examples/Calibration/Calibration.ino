 ...
 * You can overcalibrated both temperature and relative humidity.
 ...
 *  You can check SHT3x.cpp, SHT3x::UpdateData and SHT3x::GetTemperature
...
void setup() {
  ...
  HumidityReference.First = 0.; //If you really could set those ambient conditions, please, call me 8-800-355-...
  ...
  (temperature conditions was similar, we tested it over humidity changes):
  SHT30: 23.6 ; 25.1;
  TrIns: 22.3 ; 23.7;
  ...
  */
   ...
   * 10  11.1
   * 75  82.2
   * For this particular dataset overcalibration is the next (linear approximation by Microsoft Excel):
   */
